...
<template>
  <Dialog :open="open" @update:open="emit('update:open', $event)">
    <DialogScrollContent class="sm:max-w-3xl">
      ...
      <div v-else class="flex max-h-[26rem] flex-col gap-4 overflow-y-auto pr-1">
        <section v-for="section in sections" :key="section.id" class="flex flex-col gap-2">
          ...
          <div class="grid gap-2 sm:grid-cols-2">
            ...
            >
              <span class="flex flex-wrap items-center gap-2">
                ...
                <Badge v-else-if="preset.auth === 'none'" variant="secondary">no key</Badge>
              </span>
