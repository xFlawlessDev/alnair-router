...
//! with no path dependency on anything outside this repository. Only
//! OpenAI-compatible and Anthropic-native upstreams are supported — Ollama was
//! removed along with its provider module.
//!
